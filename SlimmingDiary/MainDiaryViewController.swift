...
class MainDiaryViewController: UIViewController {
    ...
    @IBOutlet var spotsDiaryBtn: UIButton!
    @IBOutlet var foodDiaryBtn: UIButton!
    @IBOutlet var displayDateBtn: UIButton!
    @IBOutlet var weightDiaryBtn: UIButton!
    @IBOutlet var btnContainerleading: NSLayoutConstraint!
    ...
    func changeBtnStatus() {
        let offset = view.frame.width / 3.0 * CGFloat(currentPage)
        ...
        btnBackgroundView.layer.add(wobble, forKey: nil)
    ...
    @IBAction func previousDay(_: UIButton) {
        calender.changeDisplayDate(.previous)
        updateDisplayeDate()
    }

    @IBAction func nextDay(_: UIButton) {
        calender.changeDisplayDate(.next)
        updateDisplayeDate()
    }

    @IBAction func calenderAction(_: Any) {
