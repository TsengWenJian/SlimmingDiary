...
class ProgressPhotoViewController: UIViewController {
    ...
    @IBOutlet var containerLabelView: UIView!
    @IBOutlet var displayImageView2: UIImageView!
    @IBOutlet var displayImageView: UIImageView!

    @IBOutlet var containerScrollView: UIView!
    @IBOutlet var imageScrollView2Trailing: NSLayoutConstraint!
    @IBOutlet var dateLabel: UILabel!
    @IBOutlet var kgLabel: UILabel!
    @IBOutlet var date2Label: UILabel!
    @IBOutlet var kg2Label: UILabel!
    @IBOutlet var isCompareBtn: UIButton!
    ...
    @IBAction func compareBtnAction(_: Any) {
        var traing: CGFloat
